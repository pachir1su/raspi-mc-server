...
| 증상 | 원인 | 해결 |
|---|---|---|
| `Unsupported class file major version` / 자바 오류 | Paper 요구 버전보다 낮은 Java | 설치 스크립트가 표시한 버전을 설치하세요. Paper 26.1+는 Java 25가 필요합니다. [설치 문서](setup.md#paper-261용-java-25)를 참고하세요. |
